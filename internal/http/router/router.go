...
func routePolicies(authzRepos AuthorizationRepositories) []routePolicy {
	...
	return []routePolicy{
		...
		{method: "GET", path: "/api/v1/bills/:id/receipt", authStrategy: authStrategyFirebase, allowedRoles: []string{"admin", "organizer", "staff", "owner"}, propertyResolver: middleware.ResourcePropertyIDWithNotFound("id", ownership.FindPropertyIDByBillID, apperr.ErrBillNotFound)},
		...
		{method: "POST", path: "/api/v1/leases/:id/checkout-settlement/preview", authStrategy: authStrategyFirebase, allowedRoles: []string{"admin", "organizer", "staff"}, propertyResolver: middleware.ResourcePropertyIDWithNotFound("id", ownership.FindPropertyIDByLeaseID, apperr.ErrLeaseNotFound)},
		...
		{method: "GET", path: "/api/v1/brand/faq-items", authStrategy: authStrategyFirebase, allowedRoles: []string{"admin", "organizer"}},
		...
		{method: "GET", path: "/api/v1/properties/:id/financial-report/:year/:month/cashflow-export", authStrategy: authStrategyFirebase, allowedRoles: []string{"admin", "organizer", "staff", "owner"}, propertyResolver: middleware.ParamPropertyID("id")},
		{method: "GET", path: "/api/v1/properties/:id/financial-report/:year/:month/profit-loss-export", authStrategy: authStrategyFirebase, allowedRoles: []string{"admin", "organizer", "staff", "owner"}, propertyResolver: middleware.ParamPropertyID("id")},
		{method: "GET", path: "/api/v1/properties/:id/operation-report/:year/:month", authStrategy: authStrategyFirebase, allowedRoles: []string{"admin", "organizer", "staff", "owner"}, propertyResolver: middleware.ParamPropertyID("id")},
		...
		{method: "GET", path: "/api/v1/properties/:id/tenant-roster", authStrategy: authStrategyFirebase, allowedRoles: []string{"admin", "organizer", "staff", "owner"}, propertyResolver: middleware.ParamPropertyID("id")},
		{method: "GET", path: "/api/v1/properties/:id/tenant-lease-roster", authStrategy: authStrategyFirebase, allowedRoles: []string{"admin", "organizer", "staff", "owner"}, propertyResolver: middleware.ParamPropertyID("id")},
